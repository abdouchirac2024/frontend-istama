...
import "../../../plugins/datatables/js/jquery.dataTables.min.js"
import "../../../plugins/datatables/js/datatables.init.js"
...
<template>
    <div>
        <header class="header vacasky-default-nav">
                    ...
                    <div class="header-right-part d-flex align-items-center flex-shrink-0">
                        <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
                            <li class="nav-item nav-notification dropdown">
                                ...
                                <div class="dropdown-widget dropdown-menu p-0">
                                    <div class="dropdown-wrapper pd-50">
                                        ...
                                        <ul class="notification-board list-unstyled">
                                            <li class="d-flex gap-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <p class="fs-16 fw-medium"><a href="#">Classic Italy Tour Package is
                                                            nearest you</a></p>
                                                    <p
                                                        class="d-flex align-items-center justify-content-between fw-semibold text-primary mb-0">
                                            ...
                                            <li class="d-flex gap-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <p class="fs-16 fw-medium"><a href="#">Grand Elysée</a> hotel booking is
                                                        confirmed.</p>
                                                    <p
                                                        class="d-flex align-items-center justify-content-between fw-semibold text-primary mb-0">
                                                        <span class="fs-14 text-gray fw-normal">2m ago</span> <span>Mark as
                                        ...
                                        <h6 class="all-notifications mb-0"> <a href="#"
                                                class="btn bg-muted text-primary w-100 fw-semibold mt-3 ff-base">View All
                                                Notifications</a> </h6>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-item nav-author">
                                <a href="#" class="nav-toggler" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img :src="('@/assets/img/admin.jpg')" alt="img" width="60" class="rounded-2">
                                    <div class="nav-toggler-content">
                                        <h5 class="ff-base fw-medium mb-0">Erica Stocklin</h5>
                                        <div class="ff-base fs-14 fw-normal text-gray">ericastocklin@gmail.com</div>
                                    </div>
                                </a>
                                    ...
                                    <div class="dropdown-wrapper">
                                        <div class="card mb-0">
                                            <div class="card-header p-3 text-center">
                                                <img :src="('@/assets/img/admin.jpg')" alt="img" width="80"
                                                    class="rounded-circle avatar">
                                                <div class="mt-2">
                                                    <h6 class="ff-base fw-medium mb-0">Erica Stocklin</h6>
                                                    <div class="ff-base fs-14 fw-normal text-gray">ericastocklin@gmail.com
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body p-3">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li>
                                                        <router-link to="/user/detail-profil"
                                                            class="fs-14 fw-normal text-dark d-block p-1">
                                                            <i class="bi bi-person me-2"></i> Profile</router-link>
                                                    </li>
                                                    <li>
                                                        <a href="account-bookings.html"
                                                            class="fs-14 fw-normal text-dark d-block p-1"><i
                                                                class="bi bi-envelope me-2 "></i> My Bookings</a>
                                                    </li>
                                                    <li>
                                                        <router-link to="/user/edit-profil"
                                                            class="fs-14 fw-normal text-dark d-block p-1">
                                                            <i class="bi bi-gear me-2"></i> Setting & Privacy</router-link>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="card-footer p-3">
                                                <a href="login.html"
                                                    class="btn btn-outline-gray bg-transparent w-100 py-2 rounded-1 text-dark fs-14 fw-medium"><i
            ...
            <div class="small-header d-flex align-items-center justify-content-between d-xl-none">
                <div class="logo">
                    <a href="../index.html" class="d-flex align-items-center gap-3 flex-shrink-0">
                        <img :src="('@/assets/img/footer-logo-2.svg')" alt="logo">
                    </a>
                </div>
                <button type="button" class="vacasky-mobile-menu-opener"><span class="close"><i
